...
<div class="admin-container">
    ...
    <?php if ($success): ?>
        <div class="alert alert-success">✓ Employer operation successful!</div>
    <?php endif; ?>
    ...
    <div class="admin-form">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <label for="brandName">Employer Name *</label>
                <input type="text" id="brandName" name="brandName" required placeholder="e.g., Acme Corp, Tech Solutions">
            </div>

            <div class="checkbox-group">
                <input type="checkbox" id="isTopBrand" name="isTopBrand">
                <label for="isTopBrand">✨ Mark as Featured Employer</label>
            </div>

            <button type="submit" class="btn-add">➕ Add Employer</button>
        </form>
    </div>
    ...
    <table class="management-table">
        ...
        <tbody>
            <?php if (empty($brands)): ?>
                <tr>
                    <td colspan="3" style="text-align: center; color: #8f8f8f; padding: 30px;">No employers yet</td>
                </tr>
            <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($brand['isTopBrand']): ?>
                                <span class="badge-top">⭐ Featured Employer</span>
                            <?php else: ?>
                                <span class="badge-more">Employer</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            ...
                            <form method="POST" style="display: inline;">
                                ...
                                <input type="hidden" name="id" value="<?= $brand['id'] ?>">
                                <button type="submit" class="btn-delete" onclick="return confirm('Delete this employer?')">🗑 Delete</button>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; ?>
